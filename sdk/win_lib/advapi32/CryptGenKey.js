var hnd90;
hnd90 = Module.findExportByName("advapi32","CryptGenKey");
Interceptor.attach(hnd90, {
    onEnter: function (args) {

        var api_arguments = {};
        api_arguments.hProv = ToHexString(get_dword(args[0]));
        api_arguments.Algid = get_crypto_prov_alg_id(args[1]);
        api_arguments.dwFlags = get_dword(args[2]);
        api_arguments.phKey = get_dword(args[3]);

        this.send_data = {}
        this.send_data.Date = Date()
        this.send_data.api_name = "CryptGenKey"
